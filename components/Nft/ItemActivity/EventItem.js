  ...
  return (
    <div className={style.eventItem}>
      <div className={`${style.event} flex-[2]`}>
        ...
        <div className={style.eventName}>Transfer</div>
      </div>
      ...
      <div className={`${style.accent} flex-[3]`}>
        {event?.from.slice(0, 5)}...{event?.from.slice(36, 41)}
      </div>
      <div className={`${style.accent} flex-[3]`}>
        {event?.to.slice(0, 5)}...{event?.to.slice(36, 41)}
      </div>
      <div className={`${style.accent} flex-[2]`}></div>
    </div>
  );
}
